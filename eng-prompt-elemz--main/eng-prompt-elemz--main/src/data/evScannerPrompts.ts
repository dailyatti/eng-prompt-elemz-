...
**ENGLISH TIP FORMAT REQUIREMENTS:**
Provide all betting recommendations in English with the following format:
- **Match:** [Team A] vs [Team B]
- **Tip:** [Specific bet type - e.g., Over/Under, Spread, Moneyline]
- **Odds:** [Current odds from bookmaker]
- **EV (Expected Value):** [Calculated EV percentage]
...
Provide all betting recommendations in English with the following format:
- **Match:** [Team A] vs [Team B]
- **Tip:** [Specific bet type - e.g., 1X2, Over/Under, BTTS]
- **Odds:** [Current odds from bookmaker]
- **EV (Expected Value):** [Calculated EV percentage]
- **Confidence:** [High/Medium/Low]
- **Reasoning:** [Brief explanation of the analysis]`;
...
- **Tip:** [Specific bet type - e.g., Match Winner, Set Betting, Games Handicap]
- **Odds:** [Current odds from bookmaker]
- **EV (Expected Value):** [Calculated EV percentage]
- **Confidence:** [High/Medium/Low]
- **Reasoning:** [Brief explanation of the analysis]`;
...
Provide all betting recommendations in English with the following format:
- **Match:** [Team A] vs [Team B]
- **Tip:** [Specific bet type - e.g., Point Spread, Total Points, Moneyline]
- **Odds:** [Current odds from bookmaker]
- **EV (Expected Value):** [Calculated EV percentage]
- **Confidence:** [High/Medium/Low]
- **Reasoning:** [Brief explanation of the analysis]`;
...
**ENGLISH TIP FORMAT REQUIREMENTS:**
Provide all betting recommendations in English with the following format:
- **Match:** [Team/Player A] vs [Team/Player B]
- **Tip:** [Specific bet type - e.g., Match Winner, Over/Under, Handicap]
- **Odds:** [Current odds from bookmaker]
- **EV (Expected Value):** [Calculated EV percentage]
- **Confidence:** [High/Medium/Low]
- **Reasoning:** [Brief explanation of the analysis]`;